  ...
  return (
    <div className="relative flex flex-1 flex-col rounded-2xl border border-[var(--border)] bg-[var(--card)] shadow-[var(--shadow-card-glow)]">
      ...
      <div
        ...
        aria-live="polite"
        aria-label={t("title")}
        className="relative flex flex-1 flex-col overflow-y-auto [overflow-anchor:none] bg-[radial-gradient(ellipse_70%_45%_at_50%_15%,oklch(0.8_0.066_85/0.04),transparent)] px-4 py-6 sm:px-8 dark:bg-[radial-gradient(ellipse_70%_45%_at_50%_15%,oklch(0.8_0.066_85/0.07),transparent)]"
      >
