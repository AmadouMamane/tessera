  ...
  "inline-flex items-center gap-1 rounded-full border px-2 py-0.5 text-xs font-medium leading-none whitespace-nowrap",
  {
    variants: {
      tone: {
        ...
        navy: "border-navy-200 bg-navy-50 text-navy-800 dark:border-navy-700 dark:bg-navy-800 dark:text-navy-100",
        gold: "border-gold-300 bg-gold-50 text-gold-800 dark:border-gold-700 dark:bg-gold-900/40 dark:text-gold-200",
        success:
        ...
        info: "border-info-500/30 bg-info-50 text-info-700 dark:bg-info-700/20 dark:text-info-50",
      },
    },
